...
public class UsersUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblUsers.setFont(new java.awt.Font("Segoe UI Emoji", 1, 24)); // NOI18N
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        txaUsers.setText(lM.displayAllAdminUsers());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsersUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
